...
export const servicesSection = [
  {
    category: "Soluciones de Infraestructura",
    services: [
      {
  ...
  {
    category: "Seguridad y Resiliencia",
    services: [
      {
...
export const aboutUsSection = [
  {
    title: "Quiénes Somos",
    description:
      "Breve descripción de la misión de la empresa, valores y compromiso de ofrecer soluciones excepcionales de TI.",
  },
];
/*
...
export const contactSection = [
  {
    ...
    description: "Formulario de contacto o detalles para consultas y citas.",
  },
];
...
export const footerSection = [
  ...
  {
    copyright: "2023 IT Ingeniería. Todos los derechos reservados.",
  },
];
/*
